  ...
  <div id="ADD" v-loading="loading">
    ...
    <body-container>
      <el-form  v-loading="loading" :model="ruleForm"  ref="ruleForm" label-width="100px" class="demo-ruleForm">
        ...
        <el-row type="flex">
          <el-form-item label="作者"  class="recruitmentTitle">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...mapActions('student',['addArticle','getArticlDetails2']),
    ...
    async created() {
      ...
      if (id) {
        ...
        this.id=data.id;
        if(this.$route.query.userId){this.ruleForm.userId=this.$route.query.userId}
